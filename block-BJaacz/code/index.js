...
console.log(addFiveToArray([15,4,7])) 
/*
...
*/
function isAdult(peopleDetails) {
  return peopleDetails.age > 18;
}
console.log(isAdult(people[0])); // false
console.log(isAdult(people[1])); // true
console.log(isAdult(people[2])); // true
...
*/
function isMale(personGender) {
  return personGender.sex === 'M'
}
...
*/
function isFemale(personGender) {
  return personGender.sex === 'F'
}
...
function isGradeB(personGrade) {
  return personGrade.grade > 8 && personGrade.grade <= 12
}
