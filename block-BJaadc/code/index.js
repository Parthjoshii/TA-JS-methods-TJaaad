...
console.log(`The first character of the "message" is ${message.charAt(0)}`)

// Log the last character of message using length like `The last character of [message] is [character]`
console.log(`The last character of the "message" is ${message.charAt(message.length-1)}`)
